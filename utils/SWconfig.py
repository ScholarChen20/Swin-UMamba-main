...
def swin_config():
    ...
    parser.add_argument('--root_dir', default="/home/cwq/MedicalDP/SwinUmamba/data/nnUNet_raw/Dataset705_Thyroid",
    ...
    parser.add_argument('--root_path', type=str,
                        default='./dataset/Thyroid', help='root dir for data')
    parser.add_argument('--dataset', type=str,
                        default='Thyroid', help='experiment_name')
    parser.add_argument('--list_dir', type=str,
                        default='./lists/Thyroid', help='list dir')
    ...
    # parser.add_argument("--dataset_name", default="evaluate")
    parser.add_argument("--n_class", default=4, type=int)
    parser.add_argument("--num_workers", default=8, type=int)         #modify
