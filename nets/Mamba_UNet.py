...
class MambaUnet(nn.Module):
    def __init__(self, img_size=224, num_classes=21843, zero_head=False, vis=False,use_checkpoint=None):
...
if __name__ == '__main__':
    net = MambaUnet(num_classes=1,use_checkpoint=None).cuda()                   #22.10M  4.35
    input = torch.randn(2, 3, 256, 256).cuda()
    predict = net(input)
    print(len(predict),predict.shape)
    cal_params_flops(net, 256, logger)
