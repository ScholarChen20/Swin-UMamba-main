...
class MHSM(nn.Module):
    ...
    def __init__(
        ...
        self.scanhead_C = ScanHead(dim_sub=self.dim_sub, d_state=d_state, gfu_t=para_dict['gfu_t'], pattern='C',
                                   route_dict=route_dict)
        self.scanhead_X = ScanHead(dim_sub=self.dim_sub, d_state=d_state, gfu_t=para_dict['gfu_t'], pattern='X',
                                   route_dict=route_dict)
        self.scanhead_S = ScanHead(dim_sub=self.dim_sub, d_state=d_state, gfu_t=para_dict['gfu_t'], pattern='S',
                                   route_dict=route_dict)
        if self.head_num == 4:
            self.scanhead_Z = ScanHead(dim_sub=self.dim_sub, d_state=d_state, gfu_t=para_dict['gfu_t'], pattern='Z',
                                       route_dict=route_dict)
