...
class SwinPA(nn.Module):
    def __init__(self, out_planes=1, encoder='vmamba_T',use_checkpoint=False):
        ...
        if self.encoder == 'vmamba_T':
            ...
            self.backbone = VSSMEncoder(dim=96,drop_path_rate=0.2,use_checkpoint=use_checkpoint)
            ...
            self.backbone = VSSMEncoder() # [64, 128, 320, 512]
        ...
        self.dmc1 = DMC1([mutil_channel[2], mutil_channel[3]], width=mutil_channel[2], up_kwargs=None)
        ...
        self.dmc3 = DMC3([mutil_channel[0], mutil_channel[1], mutil_channel[2], mutil_channel[3]],
                         width=mutil_channel[0], up_kwargs=None)
        self.DMC_fusion = DMC_fusion(mutil_channel, up_kwargs=None)
        ...
        self.decode = UNetResDecoder(num_classes=1,deep_supervision=True,features_per_stage=[96,192,384,768])
